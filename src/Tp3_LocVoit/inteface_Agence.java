...
public class inteface_Agence extends JFrame {
    ...
    class AjouteClientDiag extends JDialog{
        ...
        private JLabel jLabel1=new JLabel("Nom"),jLabel2=new JLabel("Prenom"),jLabel3=new JLabel("CIN"),jLabel4=new JLabel("Civilite");
        private JComboBox<String> jComboBox1;
        int a=-1;
        public AjouteClientDiag(int a){
    ...
    class Ajouter_VoitureDiag extends JDialog
    {
        ...
        private JLabel lab1= new JLabel("Marque"), lab2 = new JLabel("Model"),lab3 =new JLabel("Prix par jour"), lab4=new JLabel("Anne de production");
        ...
        jButton2.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent evt) {
                    ...
                    if(marque.equals(""))att=false;                   
                    String model= jTextField5.getText();
                    if(model.equals(""))att=false;                   
                    int prix=0, anne=0;
                   try
                   {
    ...
    class Louer_voit_Diag extends JDialog
    {
        ...
        public Louer_voit_Diag()
        {
            ...
            Iterator<Voiture> a=ag.tousLesVoitures();
            while (a.hasNext()) {
                Voiture v= a.next();
                if(!ag.estLoue(v)){
                    VoitCombo.addItem(v);
        ...
        jButton5.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                ...
                try {
                    ...
                    if(!jTextField8.getText().equals(""))JOptionPane.showMessageDialog(getParent(), "Critere d'annes prodcution est un nombre");
                }
                try {
                    Cprix = Integer.parseInt(jTextField9.getText());
                } catch (NumberFormatException e) {
                    if(!jTextField9.getText().equals(""))JOptionPane.showMessageDialog(getParent(), "Critere du prix est un nombre");
                }
                if (!CMarque.equals("")) 
                {
    ...
    class Rendre_Diag extends JDialog{
        ...
        Rendre_Diag(Iterator<Client> clis){
            ...
            jLabel6 = new JLabel();
            while(clis.hasNext()) jComboBox4.addItem(clis.next().getCIN());
    ...
    class SupprimerVoiture_Diag extends JDialog{
        ...
        SupprimerVoiture_Diag(Iterator<Voiture> voit){
            ...
            jButton11 = new JButton();
            jLabel6 = new JLabel();
            while(voit.hasNext()) jComboBox4.addItem(voit.next());
            jButton11.setText("Supprimer");
            jButton11.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent evt) {
                    try {
    ...
    Agence ag;
    private JButton jButton10,jButton12,jButton13,jButton7,jButton8,jButton9,jButton14,jButton15,jButton16;
